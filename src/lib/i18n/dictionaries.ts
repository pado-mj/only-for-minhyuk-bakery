...
export const dictionaries = {
  ko: {
    ...
    editor: {
      ...
      customColor: "커스텀 색상",
      uploadImage: "이미지 업로드",
      uploadHint: "내가 가진 이미지를 추가할 수 있어요!\\n배경이 없는 PNG를 추가해서 스티커처럼 사용해 보세요!",
      uploadTooLarge: "PNG, JPG, WebP · 최대 30MB까지 업로드 가능합니다",
      uploadUnsupported: "PNG, JPG, WebP · 최대 30MB까지 업로드 가능합니다",
      presetTopper: "프리셋 토퍼",
      customTopper: "텍스트 토퍼",
  ...
  en: {
    ...
    editor: {
      ...
      uploadHint: "Add your own image!\\nFor a sticker-like look, try using a PNG with a transparent background.",
      uploadTooLarge: "PNG, JPG, WebP · Files up to 30MB can be uploaded.",
      uploadUnsupported: "PNG, JPG, WebP · Files up to 30MB can be uploaded.",
  ...
  ja: {
    ...
    editor: {
      ...
      uploadHint: "お手持ちの画像を追加できます！\\n背景が透明なPNGを追加して、ステッカーのように使ってみてください！",
      uploadTooLarge: "PNG、JPG、WebP · 最大30MBまでアップロードできます。",
      uploadUnsupported: "PNG、JPG、WebP · 最大30MBまでアップロードできます。",
